...
const DEFAULT_INNER_GRADIENT = "linear-gradient(145deg, #33333366 0%, #22222244 100%)";
...
export default function ProfileCard({
  avatarUrl = "https://api.dicebear.com/9.x/avataaars/svg?seed=ixi_flower",
  iconUrl = "",
  grainUrl = "",
  innerGradient,
  ...
  const shineStyle: React.CSSProperties = {
    ...
    maskMode: iconUrl ? ("luminance" as const) : undefined,
    maskRepeat: "repeat",
    maskSize: "150%",
      ...
      style={
        {
          ...
          "--sunpillar-5": "hsl(0, 0%, 40%)",
          "--sunpillar-6": "hsl(0, 0%, 30%)",
              ...
              >
                <h3
                  ...
                  style={{
                    ...
                    backgroundImage:
                      "linear-gradient(to bottom, #fff, #888888)",
                ...
                <p
                  ...
                  style={{
                    ...
                    margin: "0 auto",
                    backgroundImage:
                      "linear-gradient(to bottom, #fff, #666666)",
                    backgroundSize: "1em 1.5em",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                    WebkitBackgroundClip: "text",
